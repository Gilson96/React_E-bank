  ...
  return (
    <section className='flex flex-col justify-center items-center w-full'>
      <div className='flex flex-col items-center border border-slate-200 rounded shadow-lg w-11/12 h-auto p-10 my-7 gap-5 justify-center'>
        ...
        <h1 className='w-full text-left text-xl font-bold uppercase'>deposit funds</h1>
        ...
        <span className='w-1/2 text-left my-5 h-0.5  '></span>
          ...
          <button onSubmit={handleSubmit} className='w-1/2 my-8 h-12 border border-slate-100 rounded-md shadow font-bold hover:bg-orange-300 hover:text-white p-2 uppercase'>Deposit Funds</button>
        </form>
      </div>
